...
public class ConfirmarPagamentoUseCaseTest
{
    ...
    public async Task Execute_DeveAdicionarErroQuandoPagamentoNaoEncontrado()
    {
        ...
        mockPagamentoGateway.Setup(g => g.GetByIdAsync(pagamentoId)).ReturnsAsync((global::Pagamentos.Domain.Entities.Pagamento?)null);
...
public class ConfirmarPagamentoTest : ConfirmarPagamentoUseCase
{
    ...
    public new Task<global::Pagamentos.Domain.Entities.Pagamento?> Execute(ConfirmarPagamentoDto dto)
    {

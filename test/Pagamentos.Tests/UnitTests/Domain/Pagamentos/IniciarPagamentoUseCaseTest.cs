...
public sealed class IniciarPagamentoUseCaseTest
{
    ...
    public async Task Execute_DeveRetornarErroQuandoPagamentoJaIniciado()
    {
        ...
        var pagamento = new global::Pagamentos.Domain.Entities.Pagamento(pedido.Id, MetodoDePagamento.Master, 150.0m, "idExterno");
...
public class IniciarPagamentoTest : IniciarPagamentoUseCase
{
    ...
    public new Task<global::Pagamentos.Domain.Entities.Pagamento?> Execute(IniciarPagamentoDto command)
    {

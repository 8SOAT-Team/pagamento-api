...
namespace Tests.UnitTests.Domain.Entities
{
    public class PagamentoTest
    {
        ...
        public void DeveLancarExcepetionQuandoPagamentoIdInvalido()
        {
            ...
            //Act
            Action act = () => new Pagamento.Domain.Entities.Pagamento(Guid.Empty, MetodoDePagamento.Pix, 100m, "idExterno");
            //Assert
        ...
        public void DeveLancarExcepetionQuandoMetodoDePagamentoInvalido()
        {
            ...
            var pedido = new Pedido(Guid.NewGuid(), listaItens);
            //Act
            Action act = () => new Pagamento.Domain.Entities.Pagamento(pedido.Id, (MetodoDePagamento)999, 100m, "idExterno");
            //Assert
